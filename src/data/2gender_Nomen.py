        ...
        html.Div(className="navigation",
                 children=[
                    ...
                    html.Div([
                        ...
                        dcc.RadioItems(id='radio-button7', options=[
                        ...
                        className="radio-sub",
                        children=[
                        dcc.RadioItems(id='radio-button8', options=[
...
@callback(
    ...
    [
        ...
        Input('popularity-slider4', 'value'),
...
def update_chart(selected_year, selected_popularity):
    ...
    grouped_df.columns=['Year', 'Amount']
    
    
    
    #grouped_df['Relative'] = grouped_df['Count'] / 50000
    
    fig = px.bar(grouped_df, x='Year', y='Amount', title='Geschlechterverteilung von Nomen in Songtexten')#, color_discrete_sequence=['#1E9D8E'])
...
@callback(
    Output('radio-button8', 'options'),
    [Input('radio-button7', 'value')]
)
